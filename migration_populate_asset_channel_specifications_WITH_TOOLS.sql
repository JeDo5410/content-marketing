-- =============================================
-- Migration Script: Populate Asset Channel Specifications (WITH TOOL INFO)
-- Description: Insert all specifications from Canva Guide Template Library INCLUDING tool URLs and button text
-- Date: 2025-11-17
-- =============================================
-- PREREQUISITES:
--   1. Run migration_add_missing_channels.sql first
--   2. Run migration_fix_unique_constraint_for_null_channel.sql second
--   3. Run migration_add_tool_columns.sql (if table already exists) OR use migration_create_asset_channel_specification.sql (if creating new)
-- =============================================
...
BEGIN TRY
    ...
    INSERT INTO test_contentmarketing.asset_channel_specification
        (asset_type_id, channel_id, headline_word_count_min, headline_word_count_max,
         ...
         additional_specs, tool_url, tool_button_text,
         status, created_at, created_by)
    VALUES
        (40, @HS_EMAIL_ID, 9, 13, 27, 34, 120, 140, 3, 5,
         '~80 chars for headline, ~220 chars for sub-headline',
         'https://www.hubspot.com/', 'Open HubSpot',
    ...
    VALUES
        (40, @WA_ID, 4, 7, 6, 10, 50, 80,
         ...
         'active', SYSUTCDATETIME(), 'migration');
    PRINT '  - Email (WhatsApp) - No tool specified';
    ...
    VALUES
        (40, @LI_MSG_ID, 8, 12, 10, 15, 80, 120,
         ...
         'active', SYSUTCDATETIME(), 'migration');
    PRINT '  - Email (LinkedIn Message) - No tool specified';
    ...
    INSERT INTO test_contentmarketing.asset_channel_specification
        (asset_type_id, channel_id, file_format, paper_size,
         ...
         body_word_count_min, body_word_count_max,
         cta_word_count_min, cta_word_count_max,
         tool_url, tool_button_text,
         status, created_at, created_by)
    VALUES
        (31, NULL, 'PDF', 'A4 (210 × 297 mm)',
         6, 10, 15, 20, 120, 140, 3, 5,
         '[Canva Template Link]', 'Open Canva Template',
         'active', SYSUTCDATETIME(), 'migration');
    ...
    VALUES
        (26, NULL, 'PDF/Word', 10,
         ...
         'https://onedrive.live.com/login', 'Open OneDrive',
         'active', SYSUTCDATETIME(), 'migration');
    ...
    INSERT INTO test_contentmarketing.asset_channel_specification
        (asset_type_id, channel_id, tool_url, tool_button_text,
         status, created_at, created_by)
    VALUES
        (44, NULL, 'https://www.capcut.com/', 'Open CapCut',
         'active', SYSUTCDATETIME(), 'migration');
    PRINT '  - Solution Video Production';
    ...
    VALUES
        (30, NULL, 'PDF/Word', 'A4 (210 × 297 mm)',
         8, 12, 15, 20, 40, 60,
         '4–6 pages, paragraphs 40–60 words',
         'https://onedrive.live.com/login', 'Open OneDrive',
         'active', SYSUTCDATETIME(), 'migration');
    ...
    -- Banner - TikTok (Has 2 tools!)
    INSERT INTO test_contentmarketing.asset_channel_specification
        (asset_type_id, channel_id, file_format,
         duration_min, duration_max,
         body_word_count_min, body_word_count_max,
         additional_specs,
         tool_url, tool_button_text, tool_url_2, tool_button_text_2,
         status, created_at, created_by)
    VALUES
        (25, 4, 'Video', '30s', '50s', 130, 150,
         '1080x1920 px, 9:16 aspect ratio',
         'https://www.capcut.com/', 'Open CapCut',
         'https://www.veed.io/', 'Open Veed.io',
         'active', SYSUTCDATETIME(), 'migration');
    PRINT '  - Banner (TikTok) - 2 tools';
    ...
    VALUES
        (25, 6, 'Video', '1 min', '3 mins', 420, 510,
         '1920x1080 px, 16:9 aspect ratio',
         '[Canva Template Link]', 'Open Canva Template',
         'active', SYSUTCDATETIME(), 'migration');
    ...
    VALUES
        (28, NULL, 'MP3', '44.1kHz',
         10, 12, 20, 25, 40, 60,
         '~70 chars for headline, ~120 chars for sub-headline, per paragraph for body',
         'https://notebooklm.google/', 'Open NotebookLM',
         'active', SYSUTCDATETIME(), 'migration');
    PRINT '  - Podcast';
    ...
    PRINT '  - Tool URLs and button text included';
    PRINT '';
